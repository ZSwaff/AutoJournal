...
public class Converter {
	...
	public static Calendar parseDateAndTime(String formatted){
        ...
        calendar.set(Calendar.MONTH, java.util.Arrays.asList(MainActivity.pureMonthReference).indexOf(split[3]));
        calendar.set(Calendar.YEAR, Integer.parseInt(split[5]));
        return calendar;
    }
